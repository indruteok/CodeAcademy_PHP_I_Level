...
<html>
    ...
    <body>
        ...
        function filtruotiGamintoja() {
            ...
            $query = mysqli_query($connection, "SELECT * FROM `telefonai` WHERE `gamintojas`='$gamintojas'");  // tas sql serveris ivykdo uzklausia prie kurio prisijungiam, antaras uzklausa nurodoma
